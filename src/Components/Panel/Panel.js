		...
		<aside className={styles.aside}>
			...
			<label>
				...
				<div className={styles.opener}>
					...
					<h4 onClick={(e) => stopShow(e, "/ViewBatteryBrand")} >View batteryBrand</h4>
				</div>
			</label>
			...
			<label>
				...
				<div className={styles.opener}>
					...
					<h4 onClick={(e) => stopShow(e, "/ViewBatteryModel")}>View Model</h4>
				</div>
			</label>
			...
			<label>
				...
				<div className={styles.opener}>
					<h4 onClick={(e) => stopShow(e, "/secondaryName")}>Create Secondary Name</h4>
					<h4 onClick={(e) => stopShow(e, "/ViewSecondaryName")}>View Secondary Name</h4>
				</div>
			</label>
			...
			<label>
				...
				<div className={styles.opener}>
					...
					<h4 onClick={(e) => stopShow(e, "/ViewCategory")}>View category</h4>
				</div>
			</label>
			...
			<label>
				...
				<div className={styles.opener}>
					<h4 onClick={(e) => stopShow(e, "/subcategory")} >Create Subcategory</h4>
					<h4 onClick={(e) => stopShow(e, "/ViewSubCategory")}>View Subcategory</h4>
				</div>
			</label>
