...
import { CreateBatteryModel,
        ...
        GetScheme,
        EditBatteryModel,
    GetBatteryModel } from '../../../../Store/Actions'
    ...
    const OnCHangeHandler = (e) => {
     ...
     if(props.BatteryBrand.data) {
         BatteryBrand = props.BatteryBrand.data.map((data) => {
             return <option key={data.id} value={data.brandName}>{data.brandName}</option>
         })
     }
     ...
     if(props.OemModel.data) {
        OemModel = props.OemModel.data.map((data) => {
             return <option key={data.id} value={data["OEM-Model Name"]}>{data["OEM-Model Name"]}</option>
         })
     }
     ...
     if(props.Segment.data) {
        segment = props.Segment.data.map((data) => {
             return <option key={data.id} value={data["segmentName"]}>{data["segmentName"]}</option>
         })
     }
     ...
     if(props.SubCategory.data) {
        SubCategory = props.SubCategory.data.map((data) => {
             return <option key={data.id} value={data["subcategoryName"]}>{data["subcategoryName"]}</option>
         })
     }
     ...
     if(props.SecondaryName.data) {
        SecondaryName = props.SecondaryName.data.map((data) => {
             return <option key={data.id} value={data["secondaryName"]}>{data["secondaryName"]}</option>
         })
     }
		...
		fileReader.onload = e => {
			...
			JSON.parse(e.target.result).map(body => {
				arr.push({
				    ...
				    "modelGroupIds (comma separated)": body["modelGroupIds (comma separated)"],		
