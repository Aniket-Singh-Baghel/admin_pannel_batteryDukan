...
import { CreateSubCategory, GetCategory, EditSubCategory, GetSubcategory } from '../../../../Store/Actions'
    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.form}>
                ...
                <input onChange={OnCHangeHandler} value={state["subcategoryName"]} name="subcategoryName" type="text" />
            </div>    

            <div className={styles.form}>
                <label htmlFor="subcategoryDesc">subcategory Desc</label>
                <input onChange={OnCHangeHandler} value={state["subcategoryDesc"]}name="subcategoryDesc" type="text" />
            </div> 
            <div className={styles.form}>
                <label htmlFor="subcategoryIcon">subcategory Icon(url)</label>
                <input onChange={OnCHangeHandler} value={state["subcategoryIcon"]} name="subcategoryIcon" type="text" />
            </div> 
            <div className={styles.form}>
